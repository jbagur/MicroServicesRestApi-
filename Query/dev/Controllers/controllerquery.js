...
exports.findQuery = function (req, res) {
    #aqui configura accesos a la dynamo DB para poder escribir
	let awsConfig = {
    "region": "us-east-1",
    "endpoint": "http://dynamodb.us-east-1.amazonaws.com",
    "accessKeyId": "AKIAJL7SAIDD3O24OYFA", "secretAccessKey": "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"
	};
    ...
    function Ads(ranked_advertiser_campaigns) {
        ...
        http.get('http://internal-PrivateLB-109908406.us-east-1.elb.amazonaws.com/ads/?advertiser_campaigns=' + ranked_advertiser_campaigns, (resp) => {
            ...
            resp.on('end', () => {
				...
				#aqui es donde se asigna el impression_ID
				for (let value in myjson.results){
					let impression_id = Math.floor((Math.random() * 100) + 1)
					Object.assign(myjson.results[value], {impression_ID: impression_id, clickURL: clickURI+"?query_id="+query_id+"&impression_id="+impression_id})
				}
    ...
    Match(category);
	#aqui hace el input a la dynamo DB
	let save = function () {
